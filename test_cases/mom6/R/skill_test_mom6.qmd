...
We start our exploration by conducting a simple nearest neighbor analysis to evaluate how well the raw MOM6 output matches the in situ data. MOM6 data in interpolated using bilinear interpolation between spatial point (lat, lon), and linear interpolation between depths.
